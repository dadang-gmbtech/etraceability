    ...
    <div class="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow p-5 border-l-4 border-purple-500">
                ...
                <p class="text-xs text-gray-400">{{ $lahans->sum('jumlah_kelapa') }} pohon</p>
            </div>
        </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-right font-medium">{{ number_format($lahan->jumlah_kelapa) }}</td>
                        ...
                        <tfoot class="bg-gray-50 text-xs font-medium text-gray-600">
                            <tr>
                                ...
                                <td class="px-4 py-2 text-right">{{ number_format($lahans->sum('jumlah_kelapa')) }} pohon</td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
