    ...
    public function getFooter(): ?\Illuminate\Contracts\Support\Htmlable
    {
        ...
        return new \Illuminate\Support\HtmlString('
            <div class="mt-4 space-y-3">
                ' . $errorHtml . '
                <a href="' . $googleUrl . '"
                   class="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">
